function crear() {
    ...
    //document.getElementById("div1").innerHTML = props;
    document.getElementsByClassName("propDiv")[0].innerHTML = props;
    document.getElementsByClassName("propDiv1")[0].innerHTML = props1;

    var showNextInterval = setInterval(showNext, 500);
    document.getElementById("p1").innerText = ' <input id="btnR" type="reset" value="RESETAR"  style="background-color:rgb(0, 96, 223);border-radius: 5px;visibility: hidden;">'
  }
